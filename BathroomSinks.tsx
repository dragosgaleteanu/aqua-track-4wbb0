...
export default function BathroomSinks(props: Props) {
  ...
  const currentWaterSpeed = 7;

  return (
    <View style={styles.container}>
      <Text style={styles.title}>Bathroom Sinks</Text>
